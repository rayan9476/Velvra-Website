...
import { DiamondIcon, RightArrowIcon } from "./icons/NewArrivalIcons";
...
function NewArrival() {
  ...
  return (
    <>
      <div
        className="flex flex-col items-center justify-center overflow-hidden w-full h-full px-2.5 md:px-4 lg:px-5 pt-8 md:pt-12 2xl:pt-16 3xl:pt-24"
        aria-label="New arrivals section"
      >
        <h2
          className="flex flex-col items-center justify-center text-[24px]  md:text-[32px] lg:text-[38px] xl:text-[44px] 2xl:text-[64px] 3xl:text-[66px] font-[Tenor_Sans] font-normal text-center text-[#0A0A0A] leading-[34.5px] md:leading-[50.5px]  lg:leading-[55.5px]  xl:leading-[60.5px] 2xl:leading-[70.5px] 3xl:leading-[90.5px] mb-6 md:mb-8 lg:mb-10 xl:mb-12 2xl:mb-16 3xl:mb-20"
        ...
        <ul
          className="menu_list  text-center text-2xl font-medium  gap-4 md:gap-12 lg:gap-16 xl:gap-24 2xl:gap-40 3xl:gap-60 flex  2xl:mb-4 3xl:mb-8"
          role="tablist"
          aria-label="Product categories"
        >
          {["All", "Apparel", "Dress", "Tshirt", "Bag"].map((item, i) => (
            <li
              key={i}
        ...
        <section className="w-full  py-10" aria-label="Product list">
          <div
            className="grid
          grid-cols-2
          sm:grid-cols-2
          ...
          >
            {filtered.length > 0 ? (
              filtered.map((p) => <ProductCards key={p.id} {...p} />)
            ) : (
              <p
                className="col-span-full text-center font-[Tenor_Sans] text-[#888888] text-[14px] md:text-[16px] tracking-[2px] py-20"
                role="status"
                aria-live="polite"
              >
                No products found.
        ...
        <div
          className="flex items-center justify-center  w-full  md:pt-4  2xl:pt-8 3xl:pt-12  pb-12 md:pb-16  lg:pb-20 xl:pb-24 2xl:pb-28"
